const strings = {
  en: {
    ...
    begin: "WAKE UP",
    clickHint: "WASD walk · mouse look · E gather · C craft · Tab pockets. Cyan sticks in front of you are loot.",
    firstHint: "1. Cyan sticks ahead — walk up, E to pick scrap and rock.  2. C crafts a hammer (1 scrap + 1 rock).  3. White crate by the airlock is the locker.",
    journal: "JOURNAL",
    o2: "O₂",
    hunger: "FOOD",
    thirst: "WATER",
  ...
  ru: {
    ...
    begin: "ПРОСНУТЬСЯ",
    clickHint: "WASD — шаг · мышь — взгляд · E — собрать · C — крафт · Tab — карманы. Голубые палки перед тобой — лут.",
    firstHint: "1. Голубые палки впереди — подойди, E: лом и камень.  2. C — молоток (1 лом + 1 камень).  3. Белый ящик у шлюза — шкаф с картошкой.",
    journal: "ЖУРНАЛ",
    o2: "O₂",
    hunger: "ЕДА",
    thirst: "ВОДА",
