...
| `systems/habitat.js` | pressure, battery, solar, temperatures, water tank, sleep Sol, crop factors; still load only while `gridOn`; dead-grid pressure bleed vs suit refill |
