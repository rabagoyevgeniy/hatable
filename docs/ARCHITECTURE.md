...
| `systems/survival.js` | seed potato, tank sip, bunk `trySleepSol` (O₂ refill follows `habCanRefillSuit`), suit range (O₂ ∩ warmth ∩ thirst ∩ hunger), console packing list, MAV cargo (not the last seed) |
