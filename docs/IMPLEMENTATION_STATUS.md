...
- Scanner science (first-scan ident including the solar farm; dust and distance hide debug loot rings unless you scan; ice/soil/wire scans unlock still fuel, planting, and cable/pump repair — not +12% XP. First-sol array cell stays ungated. No bench lab yet)
