...
- Scanner science (F names expedition sites; ice/soil/wire/comms unlock tools; desk console lists identified samples. Place ident, overlay names, loot rings, and station/locker tags share the 22 m scan pulse. Hold-F is not a planet detector. Rover identified as dead, not driven)
